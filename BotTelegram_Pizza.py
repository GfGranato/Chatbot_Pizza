...
def handle(msg):
    ...
    if nivel == 0:
        ...
        bot.sendPhoto(chat_id, media, caption='Este é o nosso Cardápio')

        bot.sendMessage(chat_id, 'Pode fazer seu pedido, digite o numero para a opção de pizza')            
    ...
    #confirmar pizza
        ...
        if (msg['text'].lower() == 'sim'):
            ...
            bot.sendMessage(chat_id, 'Ok,  digite o numero para a próxima de pizza')
            nivel = 4
        elif (unidecode(msg['text'].lower()) == 'nao'):

            bot.sendMessage(chat_id, 'Ok, digite o número para a opção de refrigerante')              
            nivel = 7
    ...
    #confirmar REFRI
        ...
        if content_type == 'text':
            if(msg['text'].lower() == 'sim'):
                ...
                bot.sendMessage(chat_id, 'Ok, digite o numero para o próximo refrigerante')
                nivel = 7
            elif (unidecode(msg['text'].lower()) == 'nao'):
